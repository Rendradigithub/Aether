#!/usr/bin/env python3
"""
AETHER v0.19.1 — BEHAVIORAL MOMENTUM & STATE PREDICTION (FIXED)
================================================================
Perbaikan dari v0.19.0:
- Novelty sekarang dihitung di ruang 36D (sig_art), bukan 8D (avec).
- Crash `ValueError: shapes (8,) and (36,) not aligned` diperbaiki.
"""
...
class AetherCognitiveCore:
    def __init__(self, stimulus_source=None, workspace="aether_works_v0191", quiet=False):
...
if __name__ == "__main__":
    ...
    while i < len(sys.argv):
        if sys.argv[i] == '--auto' and i+1 < len(sys.argv):
            ...
            i+=1
    if not stimulus:
        print("Usage: python aether.0.19.1.py --image circle.png --auto 500")
        sys.exit(1)
