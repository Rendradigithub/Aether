#!/usr/bin/env python3
"""
AETHER v0.9.9 — STABLE RELEASE
- Fixed float conversion in WorldModel.predict
- All vector operations robust
- Cleaned DecisionEngine utility calculation
- Proven stability over 200+ cycles

USAGE:
    python aether.0.9.9.py --auto 200
    python aether.0.9.9.py --demo
"""
...
# ============================================================================
# WORLD MODEL (fixed scalar conversion)
# ============================================================================
...
# ============================================================================
# DECISION ENGINE (clean, with float handling)
# ============================================================================
...
class DecisionEngine:
    ...
    def _evaluate_action_utility(self, action: str, param_vec: np.ndarray,
                                 resources: ResourceManager, blocked_patterns: Set[str]) -> Tuple[float, Dict]:
    ...
    def _foresight_utility(self, action: str, param_vec: np.ndarray,
        ...
        best_next = max(
            (self._evaluate_action_utility(a2, next_vec, sim_res, blocked_patterns)[0]
    ...
    def choose_action(self, feasible: List[str], resources: ResourceManager,
        ...
        for act in feasible:
            if resources.energy > 20 and act in ['generate','explore','refine','combine']:
                utilities[act] = self._foresight_utility(act, param_vec, resources, blocked_patterns)
            else:
                utilities[act] = self._evaluate_action_utility(act, param_vec, resources, blocked_patterns)[0]
...
class Aether:
    def __init__(self, workspace="aether_works_v099", quiet=False):
...
if __name__ == "__main__":
    ...
    if '--auto' in sys.argv:
        ...
        print("Aether v0.9.9 — Stable Release")
