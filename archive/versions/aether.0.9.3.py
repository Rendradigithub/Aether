#!/usr/bin/env python3
"""
AETHER v0.9.3 — STABILIZATION PHASE (Crossover fix)
Fixed: crossover_with_memory now handles string pattern correctly.
"""
...
# ============================================================================
# GENERATOR (with fixed crossover)
# ============================================================================
    ...
    def crossover_with_memory(self, other_params: Dict):
        for k in self.params:
            if k == 'pattern':
                ...
                # else keep current (should not happen)
...
if __name__ == "__main__":
    ...
    if '--auto' in sys.argv:
        ...
        print("Aether v0.9.3 — Stabilization Phase (fixed crossover)")
