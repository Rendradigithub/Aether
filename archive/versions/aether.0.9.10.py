#!/usr/bin/env python3
"""
AETHER v0.9.10 — FINAL STABLE RELEASE (LOCKED)
- All scalar conversions use .item()
- World model update safe
- No more TypeError
"""
...
# ============================================================================
# RESOURCE MANAGER (sama seperti sebelumnya)
# ============================================================================
...
class WorldModel:
    ...
    def predict(self, param_vec: np.ndarray) -> float:
        ...
        # SAFE: out is a 0-d array? Actually (1,) array. Use .item()
    ...
    def update(self, param_vec: np.ndarray, actual_score: float):
        ...
        for idx in indices:
            ...
            # Hidden layer update
            # delta_h = error * W2 * (1 - h^2)
            # W2 shape: (1, hidden_dim). We need to flatten it to (hidden_dim,)
            w2_flat = self.W2.flatten()  # shape (hidden_dim,)
...
class Aether:
    def __init__(self, workspace="aether_works_v0910", quiet=False):
...
if __name__ == "__main__":
    ...
    if '--auto' in sys.argv:
        ...
        print("Aether v0.9.10 — Final Stable Release")
